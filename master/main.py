...
default_html_dir = ".\..\output"
default_dir = ".\content"
assets_dir = "\\assets"
ignored_dirs = [".git"]

site_url = "http://4gn3s.github.io/MDer/"
top_image = "abstract-4.jpg"
author = "4gn3s"
title = "CAD/CAM development BLOG"
...
if __name__ == "__main__":
    fileManager.clean_all(default_html_dir, ignored_dirs)
    ...
    html = template.render(meta_description="World", meta_author=author, page_title=title, posts=htmls, site_url=site_url, image=image)
